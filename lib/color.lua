...
if not Color then
	...
	Color.white = Color:new(Color.ONE,Color.ONE,Color.ONE)
	...
	function Color.RGBtoXYZ(R,G,B)
		R,G,B=Color.clamp(R,G,B)
		return (0.4124*R +0.3576*G +0.1805*B)*100/Color.ONE,
			   (0.2126*R +0.7152*G +0.0722*B)*100/Color.ONE,
               (0.0193*R +0.1192*G +0.9505*B)*100/Color.ONE
	end
